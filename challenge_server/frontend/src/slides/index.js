...
const Slide22_PromptIdea = createIdeaTakeawaySlide({
  ...
  lead: '원하는 Data를 뽑아내는 것이 시작입니다.',
  ideaPoints: [
    'LLM을 다루기 시작할 때 가장 먼저 해야 할 일은 원하는 data를 정확히 뽑아내는 것입니다.',
    'LLM의 가장 뛰어난 능력은 writing보다 reading에 가깝습니다.',
    '문서, 메일, 회의록, 보고서를 읽히고 필요한 정보만 추출하게 하는 습관을 적극 활용하세요.',
  ],
  antiPoints: [
    '멋지게 쓰게 하는 것부터 시작하면 본질을 놓치기 쉽습니다.',
    '읽을 원문 없이 생성만 시키면 품질이 쉽게 흔들립니다.',
    '원하는 data를 정의하지 않으면 결과도 평가할 수 없습니다.',
  ],
  applyPoints: [
    '먼저 원문을 주고 필요한 항목만 추출하게 하세요.',
    '추출 결과를 검증 가능한 형태로 받으세요.',
    'reading 기반 활용이 잡힌 뒤 generation을 얹으세요.',
  ],
  closing: 'LLM 활용의 시작은 잘 쓰게 만드는 것이 아니라, 잘 읽고 필요한 data를 뽑게 만드는 것입니다.',
});
