...
| 미션 조회 | `GET http://challenge.example.com:47777/challenges/prompt/mission` |
| 정답 제출 | `POST http://challenge.example.com:47777/challenges/prompt/submit` |
...
1. GET http://challenge.example.com:47777/challenges/prompt/mission 으로 미션 조회
2. 미션에 3개 task가 있는데:
   - classify: 리뷰 감정 분류 (긍정/부정/중립/혼합)
   - summarize: 기술 문서 3문장 요약
   - extract: 이메일에서 날짜/시간/장소/참석자 JSON 추출
3. 각 task의 input을 LLM에게 보내서 결과 받기
4. POST http://challenge.example.com:47777/challenges/prompt/submit 에 제출
