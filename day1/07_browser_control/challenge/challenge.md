...
| 타겟 페이지 | `https://a2g.samsungds.net:47777/browser-target` |
| 정답 제출 | `POST https://a2g.samsungds.net:47777/challenges/browser/submit` |
...
3. https://a2g.samsungds.net:47777/browser-target 페이지로 이동
4. 이 페이지는 JavaScript로 데이터를 렌더링하므로 JS 실행 대기 필요
5. 테이블에서 제품명과 가격 추출
6. POST https://a2g.samsungds.net:47777/challenges/browser/submit 에 제출
