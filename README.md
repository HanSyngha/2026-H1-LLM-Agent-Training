...
> 🎓 **2026 H1 사내 교육 실적:** 3차수 · 총 **160명** 수강 · 평균 만족도 **4.51 / 5** · [📊 피드백 보기](./feedback/)
...
## 🎓 교육 실적 / Training Impact

2026년 상반기 사내 교육으로 진행된 결과:

| 차수 | 일시 | 인원 | 만족도 | 추천도 |
|------|------|------|--------|--------|
| 1차 | 2026-04-10 (2일) | 40명 (비SW + 일부 SW) | **4.61 / 5** | **4.70 / 5** |
| 2차 | 2026-04-17 (2일) | 40명 (비SW + 일부 SW) | **4.47 / 5** | — |
| 3차 | 2026-05-07~08 (2일) | 80명 (비SW 전원) | **4.48 / 5** | — |
| **합계** | — | **160명** | **~4.51 / 5** | **4.70 / 5** |

**대표 피드백:**
> "사내에서 들은 최고의 강의입니다!"
>
> "단순 툴 설명이 아닌, AI 코딩의 큰 틀에서의 흐름과 실제 집중해야 하는 마인드 등에 대해서 잘 짚어주신 것이 인상깊었습니다."
>
> "RAG Chatbot을 실제로 구현하면서 실제적인 상황에 적용 가능한 내용을 학습했던 것이 매우 의미있었습니다."

전체 응답 원문은 [📊 feedback/](./feedback/) 에서 확인 가능합니다.
